...
@section('content_admin')
    <div class="p-0">
        <form action="{{ route('admin.edit', ['id' => $new->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            <h1>Sửa tin tức mới</h1>
            <hr>
            ...
            <div class="mt-3">
                ...
                <input class="form-check-input" type="radio" name="status" id="flexRadioDefault1" value="1"
                    {{ old('status', $new->status) == 1 ? 'checked' : '' }}>
                ...
                <input class="form-check-input" type="radio" name="status" id="flexRadioDefault2" value="0"
                    {{ old('status', $new->status) == 0 ? 'checked' : '' }}>
            ...
            <div class="mt-3">
                ...
                <div id="display-img" class="image-preview">
                    @if (!empty($new->image_new))
                        <img src="{{ $new->image_new }}" alt="Hình ảnh đại diện" class="img-thumbnail">
                    @endif
                </div>
            </div>
